...
export default function Footer() {
    ...
    return (
        <footer className="w-full h-fit text-2xl lg:text-4xl py-10 bg-black flex justify-center items-center relative">
            <button onClick={() => window.location.assign("/")} className={`${monsieurLaDoulaise.className} antialiased absolute bottom-3 left-3 lg:p-3 antialiased text-3xl sm:text-xl lg:text-6xl text-white`}>K</button>
